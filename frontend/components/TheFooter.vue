<template>
  <footer p="y15 x15" flex="~ col gap4">
    <div flex="~ row gap2" items-center my2>
      <a href="#">
        <img src="/white-black-logo.png" class="w-1/2 lg:w-1/4 " alt="Logo">
      </a>
    </div>
    ...
    <div flex gap4 items-center>
      <ExternalLinks
        :links="{
          github_id: 'foleyb25/sanity_nuxt_poc',
        }"
      >
